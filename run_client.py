...
def self_test() -> int:
    ...
    from jewel_client.rates_page import RateBoardFrame  # noqa: F401
...
def _install_desktop_pages():
    """Register decomposed desktop pages before App builds navigation."""
    import jewel_client.main as main_module
    from jewel_client.billing_page import POSPage as BillingPOSPage
    from jewel_client.rates_page import install_rate_management
...
def launch() -> None:
    ...
    main_module = _install_desktop_pages()
    App = main_module.App
